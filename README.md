...
При создании UI/UX этого проекта использовался навык **[ui-ux-pro-max](/.cursor/skills/ui-ux-pro-max/SKILL.md)** — специализированный скилл, обеспечивающий экспертный подход к проектированию интерфейсов: 67 стилей, 96 цветовых палитр, 57 пар шрифтов и 99 UX-рекомендаций.
